...
/*   Updated: 2022/07/19 14:27:14 by ggobert          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_img_flower(t_data *data)
{
	...
	data->bee_flower_r.addr = mlx_get_data_addr(data->bee_flower_r.img,
			&data->bee_flower_r.bpp, &data->bee_flower_r.line_len, &data->bee_flower_r.endian);
	...
	data->bee_flower_l.addr = mlx_get_data_addr(data->bee_flower_l.img,
			&data->bee_flower_l.bpp, &data->bee_flower_l.line_len, &data->bee_flower_l.endian);
	...
	data->bee_flower_d.addr = mlx_get_data_addr(data->bee_flower_d.img,
			&data->bee_flower_d.bpp, &data->bee_flower_d.line_len, &data->bee_flower_d.endian);
}

void	init_img_hive(t_data *data)
{
	data->bee_hive.img = mlx_xpm_file_to_image(data->mlx_ptr, "./Texture/bee-hive.xpm",
			&data->bee_hive.bpp, &data->bee_hive.line_len);
	data->bee_hive.addr = mlx_get_data_addr(data->bee_hive.img, &data->bee_hive.bpp,
			&data->bee_hive.line_len, &data->bee_hive.endian);
	data->bee_hive_r.img = mlx_xpm_file_to_image(data->mlx_ptr, "./Texture/bee-hive_right.xpm",
			&data->bee_hive_r.bpp, &data->bee_hive_r.line_len);
	data->bee_hive_r.addr = mlx_get_data_addr(data->bee_hive_r.img, &data->bee_hive_r.bpp,
			&data->bee_hive_r.line_len, &data->bee_hive_r.endian);
	data->bee_hive_l.img = mlx_xpm_file_to_image(data->mlx_ptr, "./Texture/bee-hive_left.xpm",
			&data->bee_hive_l.bpp, &data->bee_hive_l.line_len);
	data->bee_hive_l.addr = mlx_get_data_addr(data->bee_hive_l.img, &data->bee_hive_l.bpp,
			&data->bee_hive_l.line_len, &data->bee_hive_l.endian);
	data->bee_hive_d.img = mlx_xpm_file_to_image(data->mlx_ptr, "./Texture/bee-hive_down.xpm",
			&data->bee_hive_d.bpp, &data->bee_hive_d.line_len);
	data->bee_hive_d.addr = mlx_get_data_addr(data->bee_hive_d.img, &data->bee_hive_d.bpp,
			&data->bee_hive_d.line_len, &data->bee_hive_d.endian);
}