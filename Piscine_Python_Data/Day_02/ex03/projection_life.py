...
def graphic(data_gross, data_life_expect):
	...
	merged_data_1900 = pd.merge(data_1900_gdp, data_1900_le, left_index=True, right_index=True)
...
def main():
	try:
		graphic( load("income_per_person_gdppercapita_ppp_inflation_adjusted.csv"), load("../ex00/life_expectancy_years.csv") )
